...
(function ($) {
    ...
    if ($("#tp-offcanvas-lang-toggle").length > 0) {
        window.addEventListener("click", function (e) {
            if (
                document
                    .getElementById("tp-offcanvas-lang-toggle")
                    .contains(e.target)
            ) {
    ...
    if ($("#tp-header-lang-toggle").length > 0) {
        window.addEventListener("click", function (e) {
            if (
                document
                    .getElementById("tp-header-lang-toggle")
                    .contains(e.target)
            ) {
    ...
    if ($("#tp-header-currency-toggle").length > 0) {
        window.addEventListener("click", function (e) {
            if (
                document
                    .getElementById("tp-header-currency-toggle")
                    .contains(e.target)
            ) {
                $(".tp-header-currency ul").toggleClass(
                    "tp-currency-list-open"
                );
            } else {
                $(".tp-header-currency ul").removeClass(
                    "tp-currency-list-open"
                );
            }
        });
    ...
    if ($("#tp-header-setting-toggle").length > 0) {
        window.addEventListener("click", function (e) {
            if (
                document
                    .getElementById("tp-header-setting-toggle")
                    .contains(e.target)
            ) {
    ...
    $(".tp-slider-active").slick({
        ...
        pauseOnHover: false,
        prevArrow:
            '<button type="button" class="slider-button slider-button-prev"><i class="fa-solid fa-arrow-left"></i></button>',
        nextArrow:
            '<button type="button" class="slider-button slider-button-next"><i class="fa-solid fa-arrow-right"></i></button>',
    });
