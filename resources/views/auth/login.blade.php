<x-container :title="$title">
    <main>
        ...
        <!-- login area start -->
        <section x-data="data" class="tp-login-area pb-140 p-relative z-index-1 fix">
                 ...
                 <div class="col-xl-6 col-lg-8">
                    <div class="tp-login-wrapper">
                       <div class="tp-login-top text-center mb-30">
                          <h3 class="tp-login-title">Đăng Nhập.</h3>
                          <p>Không có tài khoản? <span><a href="#">Tạo tài khoản</a></span></p>
                       </div>
                       <div class="tp-login-option">
                          <div class="tp-login-input-wrapper">
                             <div class="tp-login-input-box">
                                <div class="tp-login-input">
                                   <input x-model="email" id="email" type="email" placeholder="shofy@mail.com">
                                </div>
                                <p x-show="errors.email" x-text="errors.email" style="color: red"></p>
                             ...
                             <div class="tp-login-input-box">
                                <div class="tp-login-input">
                                   <input x-model="password" id="tp_password" type="password" placeholder="Mật khẩu">
                                </div>
                                <p x-show="errors.password" x-text="errors.password" style="color: red"></p>
                          ...
                          <div class="tp-login-bottom">
                             <button @click="login($data)" class="tp-login-btn w-100" :style="submiting ? 'cursor: not-allowed' : ''" :disabled="submiting">Đăng nhập</button>
                          </div>
                       </div>
                    </div>
                 </div>
     ...
     @push('scripts')
        <script>
            //viet middle kiem tra co api token chua bang cookie
            ...
            function login(data) {
               if (!data.email){
                  data.errors.email = 'Bạn chưa nhập email'
               }
               else if (!data.password){
                  data.errors.email = 'Bạn chưa nhập mật khẩu'
               }
               else{
                  $.ajax({
                     url: '/api/login',
