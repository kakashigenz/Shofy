              ...
              <div class="row">
                 <div class="col-lg-12">
                    <div class="tp-checkout-bill-area">
                       <h3 class="tp-checkout-bill-title">Thêm địa chỉ</h3>
                                ...
                                <div class="row">
                                   <div class="col-md-6">
                                      <div class="tp-checkout-input">
                                         ...
                                         <input name="name" type="text" style="height: unset;line-height: unset;padding-left: 8px;">
                                      </div>
                                   </div>
                                   <div class="col-md-6">
                                      <div class="tp-checkout-input">
                                         <label>Số điện thoại<span>*</span></label>
                                         <input name="phone" type="text" style="height: unset;line-height: unset;padding-left: 8px;">
                                      </div>
                                   </div>
                                   <div class="col-md-6">
                                      <div class="tp-checkout-input">
